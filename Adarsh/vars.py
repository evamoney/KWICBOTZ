...
class Var(object):
    ...
    PREMIUM_USERS = set(int(premium) for premium in os.environ.get("PREMIUM_USERS", "1004846223 1959758830 942099709 5289350909 493632262 5062213900 1022415852 1302417752 1153974507").split()) 
