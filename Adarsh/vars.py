...
class Var(object):
    ...
    PREMIUM_USERS = set(int(premium) for premium in os.environ.get("PREMIUM_USERS", "1464694779 1323905872 790339669 1122527831 1004846223 1959758830 942099709 493632262 5062213900 1022415852 1302417752 1153974507 775555533").split()) 
    ...
    if 'DYNO' in environ:
        ON_HEROKU = True
        APP_NAME = str(getenv('APP_NAME', 'kwicishere'))
